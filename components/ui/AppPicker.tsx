...
const styles = StyleSheet.create({
  ...
  selected: { fontSize: fontSize.base, color: colors.text },
  placeholder: { fontSize: fontSize.base, color: colors.muted },
  arrow: { fontSize: fontSize.base, color: colors.muted },
  ...
  option: { paddingHorizontal: spacing.lg, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: colors.border },
